...
| RISK-005 | Contact form receives spam | Security | Medium | Medium | Document the contact form spam/rate limiting strategy before public exposure, then add CAPTCHA, rate limiting or spam filtering as selected |
...
4. contact form spam before public exposure,
5. GCP complexity,
6. privacy and personal data handling.
